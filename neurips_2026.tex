...
\begin{table}[h]
  ...
  \begin{tabular}{llcccccc}
    ...
    & \textbf{\textsc{RePlaid} (Ours)}, DDIM & \ccross & $9.6$ & $16.8$ ($0.5$) & \rankfour{$\mathbf{40.1}$} ($0.01$) & N.A. & N.A. \\
    & \textbf{\textsc{RePlaid} (Ours)}, DDPM & \cmark & $33.2$ & $38.8$ ($0.0001$) & \rankone{$49.0$} ($0.01$) & N.A. & N.A. \\
