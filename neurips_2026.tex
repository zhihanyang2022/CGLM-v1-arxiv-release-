...
\begin{table}[h]
  ...
  \begin{tabular}{llcccccc}
    \toprule
    & & & \multicolumn{3}{c}{\textit{Ancestral Sampler}} & \multicolumn{2}{c}{\textit{Adaptive-order Sampler}} \\
    \cmidrule(lr){4-6} \cmidrule(lr){7-8}
    & Method & s.c. & No Temp. & Best Logit Temp. & Best Score Temp. & Conf. Threshold & Top Margin \\
    \midrule
    \multicolumn{3}{l}{\textit{Autoregressive}} \\
    & Transformer & & $52.9$ & $64.4$ ($0.2$) & N.A. & N.A. & N.A. \\
    \midrule
    \multicolumn{3}{l}{\textit{Discrete Diffusion}} \\
    & MDLM~\citep{sahoo2024simple} & & $17.0$ & $35.6$ ($0.1$) & N.A. & $37.0$ ($0.8$) & \rankthree{$\mathbf{40.3}$} \\
