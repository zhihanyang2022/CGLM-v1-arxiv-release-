...
\begin{table}[h]
  ...
  \begin{tabular}{llccccc}
    ...
    & \textbf{\textsc{RePlaid} (no s.c.) (Ours)}, DDPM & $13.3$ & $20.0$ ($0.05$) & \rankfive{$40.0$} ($0.05$) \\
    & \textbf{\textsc{RePlaid} (no s.c.) (Ours)}, DDIM & $9.6$ & $16.8$ ($0.5$) & \rankfour{$40.1$} ($0.01$) \\
    & \textbf{\textsc{RePlaid} (s.c.) (Ours)}, DDPM & $33.2$ & $38.8$ ($0.0001$) & \rankone{$\mathbf{49.0}$} ($0.01$) \\
    & \textbf{\textsc{RePlaid} (s.c.) (Ours)}, DDIM & $26.8$ & $31.2$ ($0.3$) & \ranktwo{$48.4$} ($0.01$) \\
    \bottomrule
  \end{tabular}
  \vspace{-0.5em}
\end{table}
