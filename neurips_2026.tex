...
\begin{table}[h]
  ...
  \begin{tabular}{llccccc}
    ...
    & MDLM~\citep{sahoo2024simple} & $17.0$ & $35.6$ ($0.1$) & N.A. & $37.0$ ($0.8$) & \topone{$\mathbf{40.3}$} \\
    & Duo~\citep{sahoo2025the} & $18.6$ & $37.2$ ($0.1$) & N.A. & -- & -- \\
    \midrule
    \multicolumn{2}{l}{\textit{Continuous Diffusion}} \\
    & FLM~\citep{lee2026flow} & $0.3$ & -- & --  & N.A. & N.A.  \\
    & \textbf{\textsc{RePlaid} (no s.c.) (Ours)}, DDPM & $13.3$ & $20.0$ ($0.05$) & \topthree{$40.0$} ($0.05$) & N.A. & N.A. \\
    & \textbf{\textsc{RePlaid} (no s.c.) (Ours)}, DDIM & $9.6$ & $16.8$ ($0.5$) & \toptwo{$40.1$} ($0.01$)  & N.A. & N.A.  \\
    & \textbf{\textsc{RePlaid} (s.c.) (Ours)}, DDPM & $33.2$ & $38.8$ ($0.0001$) & $\mathbf{49.0}$ ($0.01$) & N.A. & N.A.  \\
    & \textbf{\textsc{RePlaid} (s.c.) (Ours)}, DDIM & $26.8$ & $31.2$ ($0.3$) & $48.4$ ($0.01$)  & N.A. & N.A.  \\
    \bottomrule
  \end{tabular}
  \vspace{-0.5em}
\end{table}
