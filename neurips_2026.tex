...
\begin{table}[h]
  ...
  \begin{tabular}{llccccc}
    ...
    & MDLM~\citep{sahoo2024simple} & $17.0$ & \topthree{$35.6$} ($0.1$) & N.A. & \topone{$37.0$} ($0.8$) & \topone{$\mathbf{40.3}$} \\
    & Duo~\citep{sahoo2025the} & \topthree{$18.6$} & \toptwo{$37.2$} ($0.1$) & N.A. \\
    \midrule
    ...
    & \textbf{\textsc{RePlaid} (no s.c.) (Ours)}, DDIM & $9.6$ & $16.8$ ($0.5$) & \topthree{$\mathbf{40.1}$} ($0.01$) \\
    & \textbf{\textsc{RePlaid} (s.c.) (Ours)}, DDPM & \topone{$33.2$} & \topone{$38.8$} ($0.0001$) & \topone{$49.0$} ($0.01$) \\
    & \textbf{\textsc{RePlaid} (s.c.) (Ours)}, DDIM & \toptwo{$26.8$} & $31.2$ ($0.3$) & \toptwo{$48.4$} ($0.01$) \\
    \bottomrule
  \end{tabular}
  \vspace{-0.5em}
\end{table}
